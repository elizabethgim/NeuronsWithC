...
int main(){
    for(long epoch=1; epoch<=1000000;epoch++){
        ...
        double Error = get_error(target, output, OUTPUT_NODES, MSE);
        ...
        get_gradients((double *)DweightOE, DbiasOE, output_b, hidden, HIDDEN_NODES, OUTPUT_NODES);
        get_gradients((double *)DweightHE, DbiasHE, hidden_b, input, INPUT_NODES, HIDDEN_NODES);

        apply_gradient((double *)DweightOE, DbiasOE, learning_rate, (double *)weightO, biasO, INPUT_NODES, OUTPUT_NODES);
        apply_gradient((double *)DweightHE, DbiasHE, learning_rate, (double *)weightH, biasH, INPUT_NODES, OUTPUT_NODES);
    }
